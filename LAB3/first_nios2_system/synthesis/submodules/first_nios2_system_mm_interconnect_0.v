...
// 
// Generated using ACDS version 14.0 200 at 2015.02.13.13:16:20
...
module first_nios2_system_mm_interconnect_0 (
	...
	wire  [92:0] rsp_mux_001_src_data;                                                      // rsp_mux_001:src_data -> cpu_data_master_agent:rp_data
	...
	wire  [92:0] cmd_mux_src_data;                                                          // cmd_mux:src_data -> cpu_jtag_debug_module_agent:cp_data
	...
	wire  [92:0] cmd_mux_001_src_data;                                                      // cmd_mux_001:src_data -> onchip_mem_s1_agent:cp_data
	wire   [5:0] cmd_mux_001_src_channel;                                                   // cmd_mux_001:src_channel -> onchip_mem_s1_agent:cp_channel
	...
	wire  [92:0] cmd_mux_002_src_data;                                                      // cmd_mux_002:src_data -> jtag_uart_avalon_jtag_slave_agent:cp_data
	...
	wire  [92:0] cmd_mux_004_src_data;                                                      // cmd_mux_004:src_data -> sysid_control_slave_agent:cp_data
	wire   [5:0] cmd_mux_004_src_channel;                                                   // cmd_mux_004:src_channel -> sysid_control_slave_agent:cp_channel
	...
	wire  [92:0] cpu_data_master_agent_cp_data;                                             // cpu_data_master_agent:cp_data -> router_001:sink_data
	...
	wire  [92:0] cpu_jtag_debug_module_agent_rp_data;                                       // cpu_jtag_debug_module_agent:rp_data -> router_002:sink_data
	...
	wire  [92:0] onchip_mem_s1_agent_rp_data;                                               // onchip_mem_s1_agent:rp_data -> router_003:sink_data
	...
	wire  [92:0] sysid_control_slave_agent_rp_data;                                         // sysid_control_slave_agent:rp_data -> router_006:sink_data
	...
	wire  [92:0] router_src_data;                                                           // router:src_data -> cpu_instruction_master_limiter:cmd_sink_data
	wire   [5:0] router_src_channel;                                                        // router:src_channel -> cpu_instruction_master_limiter:cmd_sink_channel
	...
	wire  [92:0] cpu_instruction_master_limiter_cmd_src_data;                               // cpu_instruction_master_limiter:cmd_src_data -> cmd_demux:sink_data
	wire   [5:0] cpu_instruction_master_limiter_cmd_src_channel;                            // cpu_instruction_master_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire  [92:0] rsp_mux_src_data;                                                          // rsp_mux:src_data -> cpu_instruction_master_limiter:rsp_sink_data
	wire   [5:0] rsp_mux_src_channel;                                                       // rsp_mux:src_channel -> cpu_instruction_master_limiter:rsp_sink_channel
	...
	wire   [5:0] cpu_instruction_master_limiter_cmd_valid_data;                             // cpu_instruction_master_limiter:cmd_src_valid -> cmd_demux:sink_valid
	...
	first_nios2_system_mm_interconnect_0_router_004 router_007 (
